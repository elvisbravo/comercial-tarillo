    ...
    public function traer_productos()
    {
        ...
        $productos = DB::table('productos as p')
            ...
            ->select(
                ...
                'pr.precio_contado',
                'pr.precio_credito',
                'pr.descuento_contado',
                'pr.descuento_credito'
            )
            ->groupBy(
                'p.id',
                'p.nomb_pro',
    ...
    public function guardar(Request $request)
    {
        ...
        try {
            ...
            for ($i = 1; $i < count($resultado); $i++) {
                ...
                $respuestados = $serviciodetallealmacen->movimiento_kardex_producto($resultado[0]["almacen_origen"], $resultado[$i]["producto_id"], $resultado[$i]["cantidad"], 2, $descripcion, $traslado->serie, $traslado->correlativo, $this->validar_soles($resultado[$i]["producto_id"]), $traslado->tipo_traslado_id, $traslado->fecha, $traslado->fecha);
