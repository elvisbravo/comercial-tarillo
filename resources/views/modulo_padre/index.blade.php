    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Listado Modulos padre</h4>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control obligatorio limpiar" placeholder="Nombre del módulo padre"
                        id="name" autocomplete="off">
                </div>
                <div class="form-group mt-8rem">
                    <label for="">Ícono <strong style="color:red">(*)</strong></label>
                    <input type="text" class="form-control obligatorio limpiar" placeholder="Nombre del ícono"
                        id="icon" autocomplete="off">
                </div>
                <div class="form-group mt-8rem">
                    <label for="">Orden <strong style="color:red">(*)</strong></label>
                    <input type="number" class="form-control obligatorio limpiar" placeholder="Orden en que será mostrado"
...
<script src="{{ asset('js/modulo_padre.js') }}"></script>
