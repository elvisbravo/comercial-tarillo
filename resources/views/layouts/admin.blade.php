        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-category">Mantenimiento</li>
                    <input type="hidden" id="url_raiz_proyecto" value="{{ url('/') }}" />
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#emails" role="button" aria-expanded="false" aria-controls="emails">
                            <i class="link-icon" data-feather="mail"></i>
                            <span class="link-title">Mantenimientos</span>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
                                ...
                                <div class="row g-0 p-1">
                                    ...
                                    <div class="col-3 text-center">
                                        <a href="../apps/calendar.html" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="calendar" class="icon-lg mb-1"></i>
                                    ...
                                    <div class="col-3 text-center">
                                        <a href="profile.html" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="instagram" class="icon-lg mb-1"></i>
