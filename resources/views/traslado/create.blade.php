                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">
                                        <h5 class="font-size-14 mb-4" style="color:red"><i class="mdi mdi-arrow-right text-primary me-1" style=" font-size:18px"></i> DETALLE DE LA GUIA</h5>
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        <h5 class="font-size-14 mb-4" style="color:red"><i class="mdi mdi-arrow-right text-primary me-1" style=" font-size:18px"></i> DOCUMENTO DE REFERENCIA</h5>
                                    </button>
                                </li>
