                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            @if(App\Permisos::hasPermission('vehiculos', 2))
...
@section('js')
    ...
    <script>
        const canEdit = {{ App\Permisos::hasPermission('vehiculos', 3) ? 'true' : 'false' }};
        const canDelete = {{ App\Permisos::hasPermission('vehiculos', 4) ? 'true' : 'false' }};
    </script>
