                      ...
                      <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0 font-size-18">Consulta de Amortizaciones</h4>
                                       ...
                                       <div class="col-lg-12 col-xs-12">
                                          <div class="row">
                                                ...
                                                <div class="col-lg-6 col-xs-12">
                                                    ...
                                                    <input type="date"  class="form-control" id="fechauno">

                                                </div>

                                                <div class="col-lg-6 col-xs-12">
                                                    <label for="">Fecha Final</label> <br><br>
                                                    <input type="date"  class="form-control" id="fechados">
...
@section('js')
    ...
    <script src="{{ asset('js/consulta-amortizaciones.js') }}">
    </script>
