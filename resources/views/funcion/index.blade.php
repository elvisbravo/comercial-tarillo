    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Listado Funciones</h4>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control obligatorio limpiar" placeholder="Nombre la función"
                        id="name" autocomplete="off">
                </div>
                <div class="form-group mt-8rem">
                    <label for="">Icono</label>
                    <input type="text" class="form-control limpiar" placeholder="Nombre del ícono" id="icon"
                        autocomplete="off">
                </div>
                <div class="form-group mt-8rem">
                    <label for="">Clase</label>
                    <input type="text" class="form-control limpiar" placeholder="Nombre de la clase"
                        id="class" autocomplete="off">
                </div>
                <div class="form-group mt-8rem">
                    <label for="">Orden</label>
                    <input type="number" class="form-control limpiar" placeholder="Orden de la función"
                        id="order" autocomplete="off">
                </div>
                <div class="form-group mt-8rem">
                    <label for="" class="d-block">¿Es botón? <strong style="color:red">(*)</strong></label>
                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                        <input type="radio" class="btn-check" name="btnradio" id="btnradio_si">
                        <label class="btn btn-outline-secondary" for="btnradio_si">Sí</label>
                        <input type="radio" class="btn-check" name="btnradio" id="btnradio_no">
                        <label class="btn btn-outline-secondary" for="btnradio_no">No</label>
                    </div>
                </div>
            </div>
