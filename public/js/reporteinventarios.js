...
function generar_reporte(){
    ...
    if (datosobligatorio() == true) {
      ...
      $.get(urlgeeneral+"/reporte/listarinventario/"+ stock_id, function (data) {
        console.log(data);
...
function llenarinventario(data){
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      contenido += "<td style='padding:1px;text-align:center'> " + data[i].ubicacion + "</td>";
      contenido += "<td style='padding:1px;text-align:center'> " + data[i].nombrestock + "</td>";
      ...
      contenido += "<td style='padding:1px;text-align:center'> " + data[i].stock + "</td>";
      contenido += "<td style='padding:1px;text-align:center'> " + data[i].costo + "</td>";
