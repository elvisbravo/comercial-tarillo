...
guia.addEventListener("submit", (e) => {
    ...
    if (datosobligatorio() == true) {
        ...
        let tipo_traslado =
            selectdoc_traslado.options[selectdoc_traslado.selectedIndex].value;
        //DATOS DEL CLIENTE
        ...
        let modalidad_traslado =
            selectmodalidad.options[selectmodalidad.selectedIndex].value;
        //fecha de translado
        ...
        let ubigeo_partida =
            selectubigeo_partida.options[selectubigeo_partida.selectedIndex]
                .value;
        ...
        let ubigeo_llegada =
            selectubigeo_llegada.options[selectubigeo_llegada.selectedIndex]
                .value;
        ...
        let almacen_origen =
            selectalmacen_origen.options[selectalmacen_origen.selectedIndex]
                .value;
        ...
        let almacen_destino =
            selectalmacen_destino.options[selectalmacen_destino.selectedIndex]
                .value;
        ...
        let cabezera = new cabezeratranslado(
            tipo_traslado,
            cliente_id,
            email,
            motivo,
        ...
        for (let i = 0; i < producto_id.length; i++) {
            let detalle = new detalletraslado(
                producto_id[i].value,
                cantidad[i].value,
            );
            todo.push(detalle);
...
function traer_productos() {
    fetch(urlgeneral + "/traslado/traer_productos")
        ...
        .then((data) => {
            ...
            prod.addEventListener("addItem", function (event) {
...
function render_producto(id) {
    let selectalmacen_origen = document.getElementById("almacen_origen");
    let almacen_origen =
        selectalmacen_origen.options[selectalmacen_origen.selectedIndex].value;
