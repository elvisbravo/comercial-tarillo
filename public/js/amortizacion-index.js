...
function llenar(data){
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    contenido += "<td style='padding:1px;text-align:center'> " + data[i].obse_cre + "</td>";
    ...
    contenido +='<a href="amortizacion/'+data[i].id+'/edit" type="button" class="btn btn-info " ><i class="fas fa-check"></i> </a>';
...
function abrimodal(params) {
  ...
  $.get(urlgeeneral+"/amortizacion/detalle_product/"+params, function (data) {
